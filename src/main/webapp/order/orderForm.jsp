  ...
  <div class="order-wrapper">
    ...
    <form action="submitOrder.do" method="post" class="login-form">
      ...
      <div class="order-summary">
        ...
        <p><strong>상품 금액:</strong> <%= productTotal %> 원</p>
        <p><strong>배송료:</strong> <%= (deliveryFee == 0 ? "무료" : deliveryFee + " 원") %></p>
        <p><strong>총 결제금액:</strong> <%= totalAmount %> 원</p>
      </div>
      ...
      <div class="input-group"><div class="input-center">
